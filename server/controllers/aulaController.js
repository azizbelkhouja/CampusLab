...
//@desc     GET single aula with all unreleased showtime
...
//@desc     GET aulas by seminario and date
...
exports.getAulaBySeminario = async (req, res, next) => {
	...
	//@desc     GET aulas by seminario and date with all unreleased showtime
